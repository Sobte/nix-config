# To ensure I get the latest bun every time, I manually update it; the file comes from nixpkgs.
# See: https://github.com/NixOS/nixpkgs/blob/nixos-unstable/pkgs/by-name/bu/bun/package.nix
{
  lib,
  stdenvNoCC,
  fetchurl,
